...
-(void)initView
{
    ...
    saveBtn.frame = CGRectMake(40, _scrollView.bounds.size.height-50, (_scrollView.bounds.size.width - 40)/2.0-10, 30);
    ...
    cancelBtn.frame = CGRectMake(_scrollView.bounds.size.width / 2.0+30, _scrollView.bounds.size.height-50, (_scrollView.bounds.size.width - 40)/2.0-10, 30);
